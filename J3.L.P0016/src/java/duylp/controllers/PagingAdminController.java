 ...
 * @author Le Phuoc Duy
 */
@WebServlet(name = "PagingAdminController", urlPatterns = {"/PagingAdminController"})
public class PagingAdminController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<RequestDTO> result = daoReq.requestList(indexPage);
            request.setAttribute("REQUESTLIST", result);
            request.setAttribute("NUMBERPAGEREQ", numberPageReq);
        } catch (Exception e) {
            log("ERROR at PagingAdminController: " + e.getMessage());
        } finally {
