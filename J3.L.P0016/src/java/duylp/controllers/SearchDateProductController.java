 ...
 * @author Le Phuoc Duy
 */
@WebServlet(name = "SearchDateProductController", urlPatterns = {"/SearchDateProductController"})
public class SearchDateProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String searchDate = request.getParameter("txtDate");
            ...
            List<ProductDTO> resultUS = daoPro.findByDateProductUS(searchDate, indexPage);
            List<ProductDTO> resultLD = daoPro.findByDateProductLD(searchDate, indexPage);
            ...
            int numberPageUS = daoPro.getNumberPageDateUS(searchDate);
            int numberPageLD = daoPro.getNumberPageDateLD(searchDate);
            if (roleID.equals("US")) {
            ...
            log("ERROR at SearchDateProductController: " + e.getMessage());
        } finally {
