...
public class UserVerifyController extends HttpServlet {
    ...
    private static final String FAIL = "verifyFail.jsp";
    private static final String SUCCESS = "verifySuccess.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            UserDTO dto = new UserDTO(newEmail);
            ...
            log("ERROR at UserVerifyController: " + e.getMessage());
        } finally {
