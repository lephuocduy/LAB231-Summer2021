f<%-- 
    ...
    Created on : Jun 28, 2021, 1:57:43 PM
    Author     : Le Phuoc Duy
--%>
        ...
        <div>
                    ...
                    <div class="mt-3">
                        ...
                        <form action="MainController" method="POST">
                            Search date: <input type="date" max="<fmt:formatDate pattern = "yyyy-MM-dd"  value="${maxDate}"/>" name="txtSearchDate" value="${param.txtSearchDate}">
                                                <button type="submit" name="action" value="SearchHistoryUser"><i
            ...
            <div class="container">
                <table class="table">
                    ...
                    <tbody>
                    <c:if test="${requestScope.INFOHISTORYUSER != null}" var="info">
                        <c:forEach var="dto" items="${requestScope.INFOHISTORYUSER}">
                            <form action="MainController" method="POST"> 
                                <tr>
                                    <th>${dto.orderID}
                    ...
                    <c:if test="${!info}">
                        <c:forEach var="dto" items="${requestScope.HISTORYUSER}">
                            <form action="MainController" method="POST"> 
                                <tr>
                                    <th>${dto.orderID}
                                        <input type="hidden" name="txtOrderID" value="${dto.orderID}" />
