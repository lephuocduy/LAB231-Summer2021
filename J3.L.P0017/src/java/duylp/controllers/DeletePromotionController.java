...
public class DeletePromotionController extends HttpServlet {
    ...
    private static final Logger LOGGER = Logger.getLogger(DeletePromotionController.class);    
    private static final String ERROR = "error.jsp";
    private static final String SUCCESS = "viewPromotionList.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (dao.deletePromotion(newUserID)) {
                url = SUCCESS;
            } else {
