 ...
 * @author Le Phuoc Duy
 */
@WebServlet(name = "PromotionListController", urlPatterns = {"/PromotionListController"})
public class PromotionListController extends HttpServlet {
    
    private static final Logger LOGGER = Logger.getLogger(PromotionListController.class);
